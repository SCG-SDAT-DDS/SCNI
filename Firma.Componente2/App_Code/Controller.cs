...
{
    public WebService.WebServiceSoapClient Cliente
    {
        set;
        get;
    }
    public WebService.AuthSoap Autenticacion
    {
        set;
        get;
    }
    ...
    public Controller()
    {
        ...
        */
        ...
        Cliente = new WebService.WebServiceSoapClient();
        Autenticacion = new WebService.AuthSoap();
